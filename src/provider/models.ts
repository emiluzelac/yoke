...
export function toChatInfo(
	...
	return {
		...
		family: m.family,
		version: m.version,
		detail: isReady ? modelDetail : t('auth.apiKeyRequiredDetail'),
		tooltip: isReady ? modelTooltip : t('auth.apiKeyRequiredDetail'),
		statusIcon: isReady ? undefined : new vscode.ThemeIcon('warning'),
