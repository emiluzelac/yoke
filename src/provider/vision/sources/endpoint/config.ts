...
export const VISION_PROXY_CONFIG_KEY = 'yoke.visionProxy.config';
export const VISION_PROXY_SOURCE_KEY = 'yoke.visionProxy.source';
export const VISION_PROXY_API_KEY_SECRET = 'yoke.visionProxy.apiKey';
