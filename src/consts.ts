...
export const CONFIG_SECTION = 'yoke';
...
export const API_KEY_SECRET = 'yoke.apiKey';

/** memento key tracking whether the welcome walkthrough has been shown. */
export const WELCOME_SHOWN_KEY = 'yoke.welcomeShown';

// ---- Walkthrough ----

/** Walkthrough contribution ID. */
export const WALKTHROUGH_ID = 'yoketools.yoke#yokeGettingStarted';
